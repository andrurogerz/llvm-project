...
const CLANG_ABI char *getTraitName(TypeTrait T) LLVM_READONLY;
const CLANG_ABI char *getTraitName(ArrayTypeTrait T) LLVM_READONLY;
const CLANG_ABI char *getTraitName(UnaryExprOrTypeTrait T) LLVM_READONLY;

/// Return the spelling of the type trait \p TT. Never null.
const CLANG_ABI char *getTraitSpelling(TypeTrait T) LLVM_READONLY;
const CLANG_ABI char *getTraitSpelling(ArrayTypeTrait T) LLVM_READONLY;
const CLANG_ABI char *getTraitSpelling(UnaryExprOrTypeTrait T) LLVM_READONLY;
