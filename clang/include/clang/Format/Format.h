...
struct FormatStyle {
  ...
  CLANG_ABI std::optional<FormatStyle> GetLanguageStyle(LanguageKind Language) const;
  ...
  struct FormatStyleSet {
    ...
    CLANG_ABI std::optional<FormatStyle> Get(LanguageKind Language) const;
    ...
    // passed Style.
    CLANG_ABI void Add(FormatStyle Style);
  ...
  CLANG_ABI static FormatStyleSet BuildStyleSetFromConfiguration(
...
/// of ``getStyle()``.
extern const CLANG_ABI char *StyleOptionHelpDescription;
...
extern const CLANG_ABI char *DefaultFormatStyle;

/// The suggested predefined style to use as the fallback style in ``getStyle``.
/// Different builds can modify the value to the preferred styles.
extern const CLANG_ABI char *DefaultFallbackStyle;
